...
> **警告**：请务必将密码的位数设置得足够长，最好 7 位以上，否则[会被爆破]([https://github.com/Yidadaa/ChatGPT-Next-Web/issues/518](https://mp.weixin.qq.com/mp/profile_ext?action=home&__biz=MzkzOTIwMjkyMg==&scene=124#wechat_redirect))。
